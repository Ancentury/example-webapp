...
pipeline {
    ...
    stages {
        stage('Checkout Source Code and Logging Into Registry') {
            steps {
                ...
                script {
                    ...
                    ACCOUNT_REGISTRY_PREFIX = "107936300658.dkr.ecr.us-west-2.amazonaws.com"
                    sh """
        ...
        stage('Deploy to Production fixed server') {
            ...
            steps {
                ...
                script {
                    ...
                    sh """
                       aws ec2 reboot-instances --region us-west-2 --instance-ids i-0ff1e92d8795bea9c
                    """
                }
            }
        }
        ...
        //     steps {
        //         script {
        //             PRODUCTION_ALB_LISTENER_ARN="arn:aws:elasticloadbalancing:us-west-2:107936300658:listener/app/production-website/20215e9d495d7c1d/8a43f636156dbc51"
        //             sh """
